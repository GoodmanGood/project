                        ...
                        <div class="adv-table">
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                                ...
                                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                        ...
                                        <td><?php echo ($list["category_intro"]); ?></td>
                                        <td><?php if($list['category_status'] == 1): ?>正常<?php else: ?>关闭<?php endif; ?></td>
                                        <td>
                                            <a href="<?php echo U('edit', array('category_id' => $list['category_id']));?>" class="btn btn-xs btn-success">编辑</a>
                                            <a data-href="<?php echo U('delete', array('category_id' => $list['category_id']));?>" data-toggle="modal" data-target="#myModal" class="btn btn-danger btn-xs deleteBtn">删除</a>
                                            <!--<a onclick="return confirm('你确定要删除嘛?')" href="<?php echo U('delete', array('category_id' => $list['category_id']));?>" class="btn btn-danger btn-xs deleteBtn">删除</a>-->
    ...
    <script type='text/javascript'>
        $(function(){
            $('.deleteBtn').click(function(){
                ...
                var url = "<?php echo U('delete');?>?category_id="+del_id;
