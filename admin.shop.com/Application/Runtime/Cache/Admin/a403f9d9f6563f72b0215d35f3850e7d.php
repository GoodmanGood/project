                                ...
                                <div class="panel-body">
                                    <form role="form" action="<?php echo U();?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="role_name" class="form-control" id="exampleInputName" placeholder="请输入角色名称" value='<?php echo ($row["role_name"]); ?>'/>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputIntro">角色简述</label>
                                            <textarea class="form-control " id="exampleInputIntro" name="role_intro" placeholder="请输入角色描述"><?php echo ($row["role_intro"]); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputSort">排序</label>
                                            <input class=" form-control" id="exampleInputSort" name="role_sort" type="text"  placeholder="请输入排序数字,数字越小越靠前"  value='<?php echo ($row["role_sort"]); ?>'/>
                                        </div>
                                        <div class="form-group">
