                    ...
                    <form role="form" action="<?php echo U();?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" class="form-control">
                                <?php if(is_array($row)): $i = 0; $__LIST__ = $row;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate["good_category_id"]); ?>"><?php echo str_repeat('&nbsp;',$cate['level']-1); echo ($cate["good_category_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>所属品牌</label>
                        ...
                        <!--<div class="form-group">-->
                            ...
                            <!--<select name="supplier_id" class="form-control">-->
                                <!--<?php if(is_array($suppliers)): $i = 0; $__LIST__ = $suppliers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?>-->
                        ...
                        <div class="form-group">
                            <label>商品促销</label>
                            <?php if(is_array($sales)): $i = 0; $__LIST__ = $sales;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sale): $mod = ($i % 2 );++$i;?><input type="checkbox" name="goods_status[]" value="<?php echo ($sale["id"]); ?>"><?php echo ($sale["info_prom_type"]); ?>&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                        <div class="form-group">
                            <label>是否上架</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="goods_logo" id="logo" value="/Public/images/good.jpg"/><br/>
