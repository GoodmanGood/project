                    ...
                    <form role="form" action="<?php echo U('edit');?>" method="post" enctype="multipart/form-data">
                       <input type="hidden" name="admin_id" value="<?php echo ($row["admin_id"]); ?>"/>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="admin_username" placeholder="请输入用户名" value="<?php echo ($row["admin_username"]); ?>">
...
<script type="text/javascript" src="/Public/js/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
    ...
    <script type='text/javascript'>
        ...
        //获取所有关联权限
        var role_ids =<?php echo ($row["role_ids"]); ?>;
        //回显勾选
