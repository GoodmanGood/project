                    ...
                    <form role="form" action="<?php echo U('update');?>" method="post" enctype="multipart/form-data">
                       <input type="hidden" name="admin_id" value="<?php echo ($row["admin_id"]); ?>"/>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="admin_username" placeholder="请输入用户名" value="<?php echo ($row["admin_username"]); ?>" readonly="readonly">
