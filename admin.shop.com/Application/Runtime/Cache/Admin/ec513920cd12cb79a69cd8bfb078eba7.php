...
<section>
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo U();?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="category_name" placeholder="请输入名字" value="<?php echo ($row["category_name"]); ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputIntro">分类描述</label>
                                <textarea class="form-control " id="exampleInputIntro" name="category_intro" placeholder="请输入分类简介"><?php echo ($row["category_intro"]); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputSort">排序</label>
                                <input class=" form-control" id="exampleInputSort" name="category_sort" type="text"  placeholder="请输入排序数字,数字越小越靠前"  value="<?php echo ($row["category_sort"]); ?>"/>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="category_status" id="status" value="1" checked /> 开启
                                </label>
                            </div>
    ...
    <script type='text/javascript'>
        $(function () {
            //默认选中显示
            $('#status').prop('checked', <?php echo ($row['category_status']); ?>);
        });
    </script>
