            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-inline" action="<?php echo U('search');?>" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control">
                                    ...
                                    <?php if(is_array($categories)): $i = 0; $__LIST__ = $categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option <?php if($cate['good_category_id'] == I('get.category_id')): ?>selected<?php endif; ?> value="<?php echo ($cate["good_category_id"]); ?>">
                                            <?php $__FOR_START_1102__=1;$__FOR_END_1102__=$cate['level'];for($i=$__FOR_START_1102__;$i < $__FOR_END_1102__;$i+=1){ ?>&nbsp;&nbsp;<?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="brand_id" class="form-control">
                                    <option value="0">所有</option>
                                    <?php if(is_array($brands)): $i = 0; $__LIST__ = $brands;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?><option <?php if($brand['brand_id'] == I('get.brand_id')): ?>selected<?php endif; ?> value="<?php echo ($brand["brand_id"]); ?>"><?php echo ($brand["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if(is_array($sales)): $i = 0; $__LIST__ = $sales;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sale): $mod = ($i % 2 );++$i;?><input type="checkbox" id="sale" name="goods_status[]" value="<?php echo ($sale["id"]); ?>"><?php echo ($sale["info_prom_type"]); ?>&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        ...
                        <div class="adv-table">
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                                ...
                                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                        ...
                                        <!-- 000000111  -->
                                        <td>
                                            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i; if($list["id"] == $row["goods_id"] ): echo ($row["info_prom_type"]); endif; ?><br/><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </td>
                                        <td><?php echo $list['is_on_sale']==1?'上架':'下架';?></td>
                                        <td><?php echo ($list["good_category_name"]); ?> & <?php echo ($list["name"]); ?></td>
                                        <td>
