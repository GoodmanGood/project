                                    ...
                                    <tbody>
                                        <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                                ...
                                                <td class="center hidden-phone">
                                                    <?php echo ($row['status']==0?'隐藏':'显示'); ?>
                                                </td>
                                                <td class="center hidden-phone">
                                                    <a href="<?php echo U('edit',['good_brand_id'=>$row['good_brand_id']]);?>"  class="btn btn-xs btn-success">编辑</a>
                                                |
    ...
    <script type='text/javascript'>
        $(function(){
            $('.deleteBtn').click(function(){
                ...
                var url = "<?php echo U('delete');?>?good_brand_id="+del_id;
