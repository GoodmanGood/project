	...
	<body>
		...
		<div class="panel header">
			...
			<div class="top_menu">
				...
				<p class="is_login"><span class="uname" name="uname"><?php echo ($_SESSION['login_info']['real_name']); ?></span><span class="greetings">您好</span>
					<a href="<?php echo U('User/logout',['id'=>$_SESSION['login_info']['id']]);?>">退出</a>
				</p>
			</div>
			<p class="menu">
			...
			<div class="panel">
				...
				<div class="tabs_nav">
					...
					<ul>
						...
						<li class="user_info">个人资料</li>
						<li class="changing_pwd">修改密码</li>
						<li class="changing_icon">设置头像</li>
						<li class="security_question">保密问题和答案</li>
